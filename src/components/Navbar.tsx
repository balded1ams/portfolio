...
const NavBar  = () => {
    return(
        <nav className='sticky z-[100] h-14 inset-x-0 top-0 w-full border-b bg-[#e4e6d8] bg-opacity-50 backdrop-blur-lg transition-all'>
            <hr className=" w-[90%] md:w-[95%] h-0.5 mt-1 -my-0.5 mx-auto bg-[rgb(25,26,28)] border-0 rounded dark:bg-[#e4e6d8]"/>
            <MaxWidthWrapper>
                
                <div className='flex h-14 items-center justify-between'> //probleme chuis bourer g oubblier
